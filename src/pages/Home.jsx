    ...
    return (
        <>
            <div className="flex flex-col min-h-screen overflow-hidden">
                <Header />
                <section className="flex items-center justify-center min-h-screen bg-gradient-to-r from-yellow-200 via-yellow-300 to-yellow-400 text-gray-800 dark:text-white">
                    <div className="container mx-auto px-8 flex flex-wrap items-center justify-center">
                        ...
                        <div className="w-full md:w-1/2 flex flex-col justify-center items-start">
                            ...
                            <div className="flex w-full md:w-auto">
                                <input type="email" placeholder="Enter your email" className="p-2 rounded-l-lg focus:outline-none focus:ring-2 focus:ring-yellow-400" />
                                <button className="bg-yellow-500 text-white rounded-r-lg px-6 py-2 hover:bg-yellow-600 focus:outline-none focus:ring-2 focus:ring-yellow-500">Join Us</button>
                            </div>
                        </div>
                        {/* Image */}
